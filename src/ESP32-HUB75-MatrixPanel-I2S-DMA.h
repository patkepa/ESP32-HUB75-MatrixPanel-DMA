...
public:
  ...
  // Fast drawing functions have been removed as part of removing GFX support
...
private:
  ...
  {
    // No rotation transformation (GFX support has been removed)
  };
...
inline void MatrixPanel_I2S_DMA::drawPixel(int16_t x, int16_t y, uint16_t color)
{
  uint8_t r, g, b;
...
inline void MatrixPanel_I2S_DMA::fillScreen(uint16_t color)
{
  uint8_t r, g, b;
  color565to888(color, r, g, b);
